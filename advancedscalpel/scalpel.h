...
// --- add: validation result enum
// typedef enum { VALID_OK = 0, VALID_PARTIAL = 1, VALID_FAIL = -1 } valid_result_t;
...
typedef struct SearchSpecLine {
  ...
  unsigned long organizeDirNum;            // subdirectory # for organization 
                                           ...
                                           // --- add: optional per-type validator
  int (*validate)(int img_fd,
...
extern unsigned long long io_total_read_calls;
extern unsigned long long io_total_read_bytes;
